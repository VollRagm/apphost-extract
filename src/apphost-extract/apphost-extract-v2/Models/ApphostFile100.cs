...
{
    public class ApphostFile100 : IApphostFile
    {
        ...
        public ApphostFile100(FileStream fs, PEHeaders peheader, uint headerOffset) : base(fs, peheader)
        {
        ...
        {
            FileStream.Seek(0x14, SeekOrigin.Current);
